...
**1) R-squared**  
The plot below shows the distribution of R-squared. The 95% confidence interval for R-squared is (`r round(quantile(pull(weather_bootstrap, r.squared), probs = c(0.025, 0.975)), digits = 2)`). 
...
**2) Log(beta0 x beta1)**  
The plot below shows the distribution of log(beta0* beta1). The 95% confidence interval for the log(beta0*beta1) is (`r round(quantile(pull(weather_bootstrap, ln_betas), probs = c(0.025, 0.975)), digits = 2)`). 
```{r}
weather_bootstrap %>% 
