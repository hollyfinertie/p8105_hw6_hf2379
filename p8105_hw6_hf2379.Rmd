...
* **Birthweight and Smoking:** At the specified 25% level of significant, smoking is significantly associated with birthweight. For every 1 additional cigarette smoked per day, birthweight decreases `r model_smoken %>% filter(term == "smoken") %>% pull(estimate) %>% round(., digits = 2)` grams. This variable will be considered in the final model.
